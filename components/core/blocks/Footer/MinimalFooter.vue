        ...
        <div class="row m0 center-xs between-md">
          ...
          <div class="row social mt30">
            <a
              ...
              href="https://www.facebook.com/pg/neurovidas"
            ...
            <a
              class="social-icon mx10 brdr-circle no-underline"
              href="https://www.instagram.com/neurovidas/"
            ...
            <a
              class="social-icon mx10 brdr-circle no-underline"
              href="https://www.pinterest.com/neurovidasc60"
            ...
            <a
              class="social-icon mx10 brdr-circle no-underline"
              href="https://www.youtube.com/channel/UC-XcnK9vVA3bm9p988iKYbg"
